...
## [12.0.0-beta-1](https://github.com/mark-wiemer/mocha/compare/v12.0.0-beta-9.3...v12.0.0-beta-1) (2026-05-02)
...
* add new option 'fail-zero' ([#4716](https://github.com/mark-wiemer/mocha/issues/4716)) ([bbf0c11](https://github.com/mark-wiemer/mocha/commit/bbf0c11b29544de91a18c1bd667c975ee44b7c90))
...
* **reporter:** add output option to 'JSON' ([#4607](https://github.com/mark-wiemer/mocha/issues/4607)) ([171e211](https://github.com/mark-wiemer/mocha/commit/171e211cd2938b3f87011fa8c717292cb08adbe7))
...
* **browser:** enable 'bdd' import for bundlers ([#4769](https://github.com/mark-wiemer/mocha/issues/4769)) ([012d79d](https://github.com/mark-wiemer/mocha/commit/012d79de00698eebca8366f03466cbfbf8afaf7b))
...
* **browser:** stop using all global vars in 'browser-entry' ([#4746](https://github.com/mark-wiemer/mocha/issues/4746)) ([8421974](https://github.com/mark-wiemer/mocha/commit/8421974e8d252e2ef11602d15bed178e4f5f4534))
...
* **integration:** revert deprecation of 'EVENT_SUITE_ADD_*' events ([#4764](https://github.com/mark-wiemer/mocha/issues/4764)) ([111467f](https://github.com/mark-wiemer/mocha/commit/111467fa6fbcea153074d57442f15055c4cd592a))
...
* **parallel:** 'XUNIT' and 'JSON' reporter crash ([#4623](https://github.com/mark-wiemer/mocha/issues/4623)) ([9e0369b](https://github.com/mark-wiemer/mocha/commit/9e0369b03475d0cc4ffbd32523bdf95b287fe9b7))
...
* regex in 'update-authors.js' ([011a5a4](https://github.com/mark-wiemer/mocha/commit/011a5a43ba454fb1c3247ac51e69e855ed6ac512))
...
* using custom interface in parallel mode ([#4688](https://github.com/mark-wiemer/mocha/issues/4688)) ([3722201](https://github.com/mark-wiemer/mocha/commit/37222019348d604f741cdecc3fe58d9bb7188ba9))
...
* **website:** improve backers sprite image ([#4756](https://github.com/mark-wiemer/mocha/issues/4756)) ([0ea732c](https://github.com/mark-wiemer/mocha/commit/0ea732c1169c678ef116c3eb452cc94758fff150))
* wrong error thrown if loader is used ([#4807](https://github.com/mark-wiemer/mocha/issues/4807)) ([baa12fd](https://github.com/mark-wiemer/mocha/commit/baa12fd73e59ab6139d05d5eb76222c5d7a774ba))
...
* add complete '--delay' example ([#4744](https://github.com/mark-wiemer/mocha/issues/4744)) [ci skip] ([27bfc74](https://github.com/mark-wiemer/mocha/commit/27bfc7425fed7a9a9cadb6dabc536a0bd32abd7a))
...
* fix broken table width under 450 screen width ([#4734](https://github.com/mark-wiemer/mocha/issues/4734)) ([abfddf8](https://github.com/mark-wiemer/mocha/commit/abfddf8762a9b01efea2ba8737ab858669d7ca51))
...
* how to use 'rootHooks' in the browser ([#4755](https://github.com/mark-wiemer/mocha/issues/4755)) [ci skip] ([c7f56d1](https://github.com/mark-wiemer/mocha/commit/c7f56d13f2bf64befef42ad8299d720e2eb42152))
* improve 'grep()' and clarify docs ([#4714](https://github.com/mark-wiemer/mocha/issues/4714)) ([757b85d](https://github.com/mark-wiemer/mocha/commit/757b85dd230079901b181c68f0be82b9a3de6407))
...
* remove unsupported 'no-timeout' option ([#4719](https://github.com/mark-wiemer/mocha/issues/4719)) [ci skip] ([f19d3ca](https://github.com/mark-wiemer/mocha/commit/f19d3ca672e71950788bb577a7f3fb1cbf6c2d1b))
...
* **ci:** add Node v17 to test matrix ([#4777](https://github.com/mark-wiemer/mocha/issues/4777)) ([a99d40c](https://github.com/mark-wiemer/mocha/commit/a99d40c1f78fec00dd9640c7a8a097b73c3b904f))
...
* **deps:** remove 'wide-align' ([#4754](https://github.com/mark-wiemer/mocha/issues/4754)) ([a87461c](https://github.com/mark-wiemer/mocha/commit/a87461caf23999a8b0a64b5f46486b53900a8461))
...
* **devDeps:** remove 'cross-spawn' ([#4779](https://github.com/mark-wiemer/mocha/issues/4779)) ([3b4cc05](https://github.com/mark-wiemer/mocha/commit/3b4cc05f3fa0502d5d714a8f62ac8785267aa695))
...
* **devDeps:** update 'eslint' and its plugins ([#4737](https://github.com/mark-wiemer/mocha/issues/4737)) ([4860738](https://github.com/mark-wiemer/mocha/commit/4860738af9de9493fade35aea3df65dc7461e100))
...
* **devDeps:** update 'prettier' ([#4776](https://github.com/mark-wiemer/mocha/issues/4776)) ([ac43029](https://github.com/mark-wiemer/mocha/commit/ac43029d6a86150a48ccd59e50e89ca10c72a9c0))
...
* **esm:** remove code for Node versions &lt;10 ([#4736](https://github.com/mark-wiemer/mocha/issues/4736)) ([97b8470](https://github.com/mark-wiemer/mocha/commit/97b84708afb42e552cb906a54f9f2aa2e6a98ba4))
...
* **gha:** update 'stale.yml' ([#4718](https://github.com/mark-wiemer/mocha/issues/4718)) [ci skip] ([9f82ccb](https://github.com/mark-wiemer/mocha/commit/9f82ccbd1efa35b8007fcefaa56f563f5145ae42))
...
* update some devDependencies ([#4733](https://github.com/mark-wiemer/mocha/issues/4733)) ([e975675](https://github.com/mark-wiemer/mocha/commit/e97567585726ca407be50baa5551ad8c5df07749))
* update some devDependencies ([#4775](https://github.com/mark-wiemer/mocha/issues/4775)) ([9c9fcb5](https://github.com/mark-wiemer/mocha/commit/9c9fcb5fd769ea5bf8ec6bc513478fa777055d5a))
...
* **v9.1.0:** release ([014e47a](https://github.com/mark-wiemer/mocha/commit/014e47a8b07809e73b1598c7abeafe7a3b57a8f7))
* **v9.1.0:** update CHANGELOG [ci skip] ([3a14b28](https://github.com/mark-wiemer/mocha/commit/3a14b28bdfd785828ec862fe9fa8d19a651fd63c))
* **v9.1.1:** release ([654b5df](https://github.com/mark-wiemer/mocha/commit/654b5df4391172e69fe226dc36ebd1c89b20be53))
* **v9.1.1:** update CHANGELOG [ci skip] ([a26cca9](https://github.com/mark-wiemer/mocha/commit/a26cca9254f41ed5a049990da8093a9c4151e0fd))
* **v9.1.2:** release ([18a1055](https://github.com/mark-wiemer/mocha/commit/18a1055396744e3284b113bb114f52298f5e35ab))
* **v9.1.2:** update CHANGELOG [ci skip] ([06f3f63](https://github.com/mark-wiemer/mocha/commit/06f3f636c9056e88d79c64f50d0d0c14f5d7ac6c))
* **v9.1.3:** release ([28b4824](https://github.com/mark-wiemer/mocha/commit/28b482472a519b7abaf30a18b8ad709707bfd5a7))
* **v9.1.3:** update CHANGELOG [ci skip] ([3dcc2d9](https://github.com/mark-wiemer/mocha/commit/3dcc2d9563c7a74edad2a68bcee2a3990140ac70))
* **v9.1.4:** release ([0a1b7f8](https://github.com/mark-wiemer/mocha/commit/0a1b7f8a1505738449e8b0275d91664b5bae3d95))
* **v9.1.4:** update CHANGELOG [ci skip] ([a04d050](https://github.com/mark-wiemer/mocha/commit/a04d050b42819602e5c952a31a8162470a39db35))
