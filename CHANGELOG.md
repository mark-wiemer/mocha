...
- move to personal scope, add personal notice
...
- add MOCHA\_OPTIONS env variable ([#4835](https://github.com/mark-wiemer/mocha/issues/4835)) ([5b7af5e](https://github.com/mark-wiemer/mocha/commit/5b7af5eec2098f094fe1601b0c5b85499fa67828))
...
- allow release-please to run on workflow-dispatch ([bb87a56](https://github.com/mark-wiemer/mocha/commit/bb87a56e98390781cf8b9c3af0af12cbc7bbb9c3))
...
- move to personal scope, add personal notice ([4e3fa78](https://github.com/mark-wiemer/mocha/commit/4e3fa78e0ee924415beeb2718c835b34994c6ddb))
...
- control stringification of error message ([#4128](https://github.com/mark-wiemer/mocha/issues/4128)) ([1c4e623](https://github.com/mark-wiemer/mocha/commit/1c4e623c020c97269922dc9e23a951f63ad8f7b8))
...
- **esm:** allow `import` from mocha in parallel ([#4574](https://github.com/mark-wiemer/mocha/issues/4574)) ([8d6d1e3](https://github.com/mark-wiemer/mocha/commit/8d6d1e359e50badc27c48e5b1aa0c577907663e9))
...
- fix syntax of workflow disptatch trigger ([35308c4](https://github.com/mark-wiemer/mocha/commit/35308c4985f2a2bc4b444e8f82dd238c94fdd6ed))
...
- **integration:** revert deprecation of 'EVENT\_SUITE\_ADD\_\*' events ([#4764](https://github.com/mark-wiemer/mocha/issues/4764)) ([111467f](https://github.com/mark-wiemer/mocha/commit/111467fa6fbcea153074d57442f15055c4cd592a))
- karma-mocha should run both browser bundles ([#4663](https://github.com/mark-wiemer/mocha/issues/4663)) ([f033ff1](https://github.com/mark-wiemer/mocha/commit/f033ff1ab561101e956285924343c23150cd6595))
...
- make it().timeout() work again ([#4599](https://github.com/mark-wiemer/mocha/issues/4599)) ([6a47776](https://github.com/mark-wiemer/mocha/commit/6a47776178826323efd0d3278f8cddd3746544ed))
...
- remove job count from parallel mode debug log ([#4416](https://github.com/mark-wiemer/mocha/issues/4416)) ([31116db](https://github.com/mark-wiemer/mocha/commit/31116dbf825487490d5416c95b2685e18e7359d3))
...
- use original require() error for TS files if ERR\_UNKNOWN\_FILE\_EXTENSION ([#5408](https://github.com/mark-wiemer/mocha/issues/5408)) ([ebdbc48](https://github.com/mark-wiemer/mocha/commit/ebdbc487693254498de62068c59e3e43d078eff1))
...
- add "options.require" to Mocha constructor ([#4630](https://github.com/mark-wiemer/mocha/issues/4630)) \[ci skip] ([d35eb9d](https://github.com/mark-wiemer/mocha/commit/d35eb9debd437a0a88281e11fb390934848940b3))
...
- add example of generating tests with a closure ([#4494](https://github.com/mark-wiemer/mocha/issues/4494)) ([9f2dd41](https://github.com/mark-wiemer/mocha/commit/9f2dd41292615ae7798ac47d37202e37f02a266e))
...
- dynamic tests with top-level await ([#4617](https://github.com/mark-wiemer/mocha/issues/4617)) \[ci skip] ([8a2da76](https://github.com/mark-wiemer/mocha/commit/8a2da76001142005826e544e4fb702ae2a77797f))
...
- fix javascript syntax errors ([#4555](https://github.com/mark-wiemer/mocha/issues/4555)) ([c667d10](https://github.com/mark-wiemer/mocha/commit/c667d1060f97da24abf48e41a284e037f0b410a0))
...
- fix v3\_older changelog duplicate headings ([#5602](https://github.com/mark-wiemer/mocha/issues/5602)) ([a750518](https://github.com/mark-wiemer/mocha/commit/a7505180b64541ac71639ec3d1193f26e73527d9))
...
- update missed default extensions ([#4608](https://github.com/mark-wiemer/mocha/issues/4608)) \[ci skip] ([dc0ec84](https://github.com/mark-wiemer/mocha/commit/dc0ec8455f6eaca993b82d322e89f5f3244691ff))
...
- **deps:** chokidar@3.4.3 ([3b333ec](https://github.com/mark-wiemer/mocha/commit/3b333ecf6168943605caa1bcd07b2acf38835057))
...
- **deps:** upgrade all to latest stable ([#4556](https://github.com/mark-wiemer/mocha/issues/4556)) ([1a05ad7](https://github.com/mark-wiemer/mocha/commit/1a05ad706399f3932fbbad3ff0180456c867fb87))
- **deps:** upgrade to latest stable ([2852505](https://github.com/mark-wiemer/mocha/commit/28525054220a26022f9c049c08d578a18c874d7e))
...
- **devDeps:** upgrade '[**@11ty/eleventy**](https://github.com/11ty/eleventy)' to v1.0.0 ([#4844](https://github.com/mark-wiemer/mocha/issues/4844)) ([b46db73](https://github.com/mark-wiemer/mocha/commit/b46db73fa0e58c92bde925eaa4054210b771b5a9))
...
- utils.type() ([#4457](https://github.com/mark-wiemer/mocha/issues/4457)); closes [#4306](https://github.com/mark-wiemer/mocha/issues/4306) ([1aa182b](https://github.com/mark-wiemer/mocha/commit/1aa182b95c58b0936e94364f7baf56636690b503))
