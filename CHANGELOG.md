...
## [12.0.0](https://github.com/mark-wiemer/mocha/compare/v11.7.7...v12.0.0) (2026-06-19)
...
* add --fail-hook-affected-tests option to report skipped tests as failed ([#5519](https://github.com/mark-wiemer/mocha/issues/5519)) ([#6052](https://github.com/mark-wiemer/mocha/issues/6052)) ([7830309](https://github.com/mark-wiemer/mocha/commit/78303092b0f7a6e5c328d3cc4e7246e2bb02d511))
...
* add Mocha to global variable ([2b8a1ff](https://github.com/mark-wiemer/mocha/commit/2b8a1ff636d58b023ae727dcef8e0c5d7784496e))
...
* make `describe().timeout()` work ([aafe6fd](https://github.com/mark-wiemer/mocha/commit/aafe6fd8c8f0a897c35cfb228aa8ecf43805b697))
...
* surface ts-node compile errors ([#6045](https://github.com/mark-wiemer/mocha/issues/6045)) ([3477563](https://github.com/mark-wiemer/mocha/commit/3477563fb99b5e294e7b940716ee95b3d28dfb84))
* swallow more `require` errors from *ts files ([#5498](https://github.com/mark-wiemer/mocha/issues/5498)) ([d89dbaf](https://github.com/mark-wiemer/mocha/commit/d89dbaf23d093c22ab72e124dcaed110f3b0228d))
...
* **test:** replace `wmic` usage with native Windows API ([#5694](https://github.com/mark-wiemer/mocha/issues/5694)) ([73ebdfa](https://github.com/mark-wiemer/mocha/commit/73ebdfadb95198704ca57ec8087d97f7f3a7a37a))
...
* **vulnerabilty:** update to serialize-javascript@3.1 ([f073689](https://github.com/mark-wiemer/mocha/commit/f0736891eb6c903f141c6df779c6481a5edf337e))
...
* document Node.js --enable-source-maps flag ([80863b1](https://github.com/mark-wiemer/mocha/commit/80863b14709450f8d4eb7e22722d2de79ad62688))
...
* add modern Netlify to v11.x branch ([#6082](https://github.com/mark-wiemer/mocha/issues/6082)) ([26deb23](https://github.com/mark-wiemer/mocha/commit/26deb2319892b0c3e297c9364f2c9a0e24455489)), closes [#5696](https://github.com/mark-wiemer/mocha/issues/5696)
...
* format all code ([#5629](https://github.com/mark-wiemer/mocha/issues/5629)) ([0696784](https://github.com/mark-wiemer/mocha/commit/0696784dd2d7f9b11471acd5854603fa57fe6fab))
...
* remove Netlify ([#5630](https://github.com/mark-wiemer/mocha/issues/5630)) ([8d01d33](https://github.com/mark-wiemer/mocha/commit/8d01d335becbcb12439328be90ce75351418d787))
...
* run tests on PRs for and pushes to v11.x ([#5525](https://github.com/mark-wiemer/mocha/issues/5525)) ([8b21b38](https://github.com/mark-wiemer/mocha/commit/8b21b3820e99d8c50c024ad1fbac8b78a3293d8d))
* setup release-please for v11 ([#5522](https://github.com/mark-wiemer/mocha/issues/5522)) ([663fff4](https://github.com/mark-wiemer/mocha/commit/663fff4b06ed3a1c70483c6ed8911ff0b89fa7b5))
...
* **v11.x:** release 11.7.5 ([#5523](https://github.com/mark-wiemer/mocha/issues/5523)) ([9a6a5db](https://github.com/mark-wiemer/mocha/commit/9a6a5db8401dec63ea81093dd862e9e9b13b44d0))
* **v11.x:** release 11.7.6 ([#5632](https://github.com/mark-wiemer/mocha/issues/5632)) ([3765ba0](https://github.com/mark-wiemer/mocha/commit/3765ba0d9bd9e8918405b681991b982d3f8d4d7e))
* **v11.x:** release 11.7.7 ([#6068](https://github.com/mark-wiemer/mocha/issues/6068)) ([41f2b95](https://github.com/mark-wiemer/mocha/commit/41f2b95e1d33a062ba7cf435200336e42f6082ef))
