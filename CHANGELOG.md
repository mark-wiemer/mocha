...
## [12.0.0-rc.1](https://github.com/mark-wiemer/mocha/compare/v12.0.0-rc.1...v12.0.0-rc.1) (2026-06-21)
...
* drop support of 'growl' notification ([#4866](https://github.com/mark-wiemer/mocha/issues/4866))
* **deps:** upgrade 'minimatch' ([#4865](https://github.com/mark-wiemer/mocha/issues/4865))
* rename 'bin/mocha' to 'bin/mocha.js' ([#4863](https://github.com/mark-wiemer/mocha/issues/4863))
...
* **esm:** ability to decorate ESM module name before importing it ([#4945](https://github.com/mark-wiemer/mocha/issues/4945)) ([73bb819](https://github.com/mark-wiemer/mocha/commit/73bb81904fa017fc474973ce9b1e8fc325709142))
...
* **browser:** failed test icon color ([#4946](https://github.com/mark-wiemer/mocha/issues/4946)) ([b0a0fb8](https://github.com/mark-wiemer/mocha/commit/b0a0fb808c6d771f198fca120527222f92edaa57))
* **browser:** increase contrast for replay buttons ([#4912](https://github.com/mark-wiemer/mocha/issues/4912)) ([4e06a6f](https://github.com/mark-wiemer/mocha/commit/4e06a6fd00537bcdb1b6fd98b4684875356193f9))
...
* fix 'fgrep' url ([#4873](https://github.com/mark-wiemer/mocha/issues/4873)) ([b863359](https://github.com/mark-wiemer/mocha/commit/b863359cc80e3db06b180bff9e3c21afd0b2acd7))
...
* remove duplicated header ([#4944](https://github.com/mark-wiemer/mocha/issues/4944)) ([0a10ddc](https://github.com/mark-wiemer/mocha/commit/0a10ddc1213c208ccc106acc9e8bf372a25f0dc4))
...
* replace 'git.io' short links ([#4877](https://github.com/mark-wiemer/mocha/issues/4877)) [ci skip] ([2b98521](https://github.com/mark-wiemer/mocha/commit/2b98521756e69d3f0cdb36855b446954ba2bdf74))
...
* **ci:** add Node v18 to test matrix ([#4876](https://github.com/mark-wiemer/mocha/issues/4876)) ([007fa65](https://github.com/mark-wiemer/mocha/commit/007fa65d5f382916b0c264cde395c0051aef7830))
* **ci:** add Node v19 to test matrix ([#4974](https://github.com/mark-wiemer/mocha/issues/4974)) ([37deed2](https://github.com/mark-wiemer/mocha/commit/37deed262d4bc0788d32c66636495d10038ad398))
* **ci:** conditionally skip 'push' event ([#4872](https://github.com/mark-wiemer/mocha/issues/4872)) ([59f6192](https://github.com/mark-wiemer/mocha/commit/59f619227428e22265b26d3788505d6e081c0e2a))
* **ci:** ignore changes to docs files ([#4871](https://github.com/mark-wiemer/mocha/issues/4871)) ([baaa41a](https://github.com/mark-wiemer/mocha/commit/baaa41ae42523977446c4c2c56f716b9d3563d3d))
* **ci:** upgrade GH actions to latest versions ([#4899](https://github.com/mark-wiemer/mocha/issues/4899)) ([84b2f84](https://github.com/mark-wiemer/mocha/commit/84b2f846148b180d6e1af088f77358a85c81d1ba))
...
* **ci:** workaround for firefox error ([#4933](https://github.com/mark-wiemer/mocha/issues/4933)) ([8f3c37b](https://github.com/mark-wiemer/mocha/commit/8f3c37b6b77b6754cd9445204c536c1a0671450a))
...
* **deps:** update 'glob' to v8 ([#4970](https://github.com/mark-wiemer/mocha/issues/4970)) ([d722d00](https://github.com/mark-wiemer/mocha/commit/d722d0038602eeb6968616b49ec79288100fdc72))
...
* **deps:** upgrade 'minimatch' ([#4865](https://github.com/mark-wiemer/mocha/issues/4865)) ([3946453](https://github.com/mark-wiemer/mocha/commit/3946453dedc8bbc7504f162ee95cb2b14997adc8))
...
* **devDeps:** remove unused depedencies ([#4949](https://github.com/mark-wiemer/mocha/issues/4949)) ([fc4ac58](https://github.com/mark-wiemer/mocha/commit/fc4ac58f1fda1a178b26189398b65f66f6561716))
* **devDeps:** update 'ESLint' to v8 ([#4926](https://github.com/mark-wiemer/mocha/issues/4926)) ([51d4746](https://github.com/mark-wiemer/mocha/commit/51d4746cf6ccefdcfcbc841c92f70efaa338e34f))
...
* drop support of 'growl' notification ([#4866](https://github.com/mark-wiemer/mocha/issues/4866)) ([ac81cc5](https://github.com/mark-wiemer/mocha/commit/ac81cc53788e11f1dad5dae9c300b16049ed934f))
...
* **esm:** remove code for Node v12 ([#4874](https://github.com/mark-wiemer/mocha/issues/4874)) ([f6695f0](https://github.com/mark-wiemer/mocha/commit/f6695f0df57f7ba8fae58341de0abeb7bdfd0d31))
...
* fix the ci ([#5020](https://github.com/mark-wiemer/mocha/issues/5020)) ([f8f9fd5](https://github.com/mark-wiemer/mocha/commit/f8f9fd57740f964df6ee31fd6514a179fce453e4))
...
* rename 'bin/mocha' to 'bin/mocha.js' ([#4863](https://github.com/mark-wiemer/mocha/issues/4863)) ([592905b](https://github.com/mark-wiemer/mocha/commit/592905b204fb3b6ef366f839994595e236a27e06))
...
* update dependencies ([#4878](https://github.com/mark-wiemer/mocha/issues/4878)) ([fbe7a24](https://github.com/mark-wiemer/mocha/commit/fbe7a24269631b6f7c5d259cc8ce26b83b2e60dc))
...
* use standard 'Promise.allSettled' instead of polyfill ([#4905](https://github.com/mark-wiemer/mocha/issues/4905)) ([77c18d2](https://github.com/mark-wiemer/mocha/commit/77c18d29c565e68a0d487e357765acb5ec776cc6))
...
* **v10.0.0:** release ([023f548](https://github.com/mark-wiemer/mocha/commit/023f548213e571031b41cabbcb8bb20e458b2725))
* **v10.0.0:** update CHANGELOG ([62b1566](https://github.com/mark-wiemer/mocha/commit/62b1566211a631b22f4bd7d888cd2c046efdd9e4))
* **v10.1.0:** release ([5f96d51](https://github.com/mark-wiemer/mocha/commit/5f96d511dbf913f135b92198aab721a27f6b44fe))
* **v10.1.0:** update CHANGELOG ([ed74f16](https://github.com/mark-wiemer/mocha/commit/ed74f16878f6520411d9a391c5f184056be6da30))
* **v10.2.0:** release ([202e9b8](https://github.com/mark-wiemer/mocha/commit/202e9b8b4d1b6611c96d95d631c49d631d88c827))
* **v10.2.0:** update CHANGELOG ([6782d6d](https://github.com/mark-wiemer/mocha/commit/6782d6d0757a5e7b49b291bcae173316ec00c513))
